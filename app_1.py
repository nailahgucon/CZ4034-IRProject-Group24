...
from frontend.views.processes.spellcheck import spellcheck
from frontend.views.processes.mlt import mlt
from frontend.views.processes.autocomplete import autocomplete
...
def query():
  if request.method == 'GET':
    ...
    list_of_unique_styles = list(set(db.get_styles))
    print("These are the list of unique styles:")
    print(list_of_unique_styles)

    list_of_unique_categories = ["Eatery", "Hotel"]
    # ------------------------
    # # Parse Solr results
    # results = json.loads(response.text)["response"]["docs"]
    # save the results to records class, don't change myRecords and totalPages.
